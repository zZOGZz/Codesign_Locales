...
const LOCALE = {
    ...
    "purchase_vehicle":"Press <kbd>E</kbd> to select the vehicle.",
    "confirm_vehicle":"Press <kbd>E</kbd> <strong>AGAIN</strong> to purchase.",

    "test_vehicle":"Press <kbd>G</kbd> to test drive the vehicle"
}
